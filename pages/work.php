    ...
    <div class="container work">
        <div class="work-header">
            <h2 class="work-header-heading">Немного о моих работах</h2>
        </div>
        <div class="work-wrapper">
            <!-- work-card-1 start -->
            <div class="work-card">
                <div class="work-card-image">
                    <img src="image/myWork/constructor.jpg" alt="image">
                </div>
                <div class="work-card-description">
                    <div class="work-card-description-head">
                        <img src="image/ellipse.svg" alt="icon">
                        <h3>Сайт <span>—</span> платформа для обучения Конструктор</h3>
                    </div>
                    <div class="work-card-description-paragraph">
                        <p>Проект этого сайта я разрабатывала в 2019 году. Недавно у меня дошли руки до его вёрстки.
                            <br>
                            <br>
            ...
            <div class="work-card">
                ...
                <div class="work-card-description">
                    ...
                    <div class="work-card-description-paragraph">
                        <p>Один из первых сайтов, который я верстала. Макет был предоставлен командой GeekBrains, в
            ...
            <div class="work-card">
                ...
                <div class="work-card-description">
                    ...
                    <div class="work-card-description-paragraph">
                        <p>Сайт свёрстан по макету предоставленному командой GeekBrains, в период обучения у них.
            ...
            <div class="work-card">
                ...
                <div class="work-card-description">
                    ...
                    <div class="work-card-description-paragraph">
                        <p>Лэндинг свёрстан по макету найденному в телеграмм канале, для тренировки.
